                ...
                <div class="col-md-12 text-left">
                    <div class="main-title main-title-left wow fadeInLeft">
                        <div class="main-shadow-heading">
                            <h2>Hello, Welcome To Briskit Agency</h2>
                        </div>
                        <h2>Hello, Welcome To Briskit Agency</h2>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="welcome-2-left-content wow fadeInLeft">
                            <p>we’re Briskit Agency, an award-winning digital marketing agency based in New York. Founded by Begha over many cups of tea at her kitchen table in 2009, our brand promise is simple: to provide powerful digital marketing solutions to
                                small and medium businesses that are looking to build success online.</p>
            ...
            <div class="row">
                <div class="col-sm-6 col-md-4 no-padding">
                    <div class="our-philosophy-inner our-philosophy-inner-bg-1">
                        <h2>Our Mission</h2>
                        <p>We encourage every team member to be a whole person. We have a flexible, high trust environment that is focused on doing great work. We’re growing and moving at a fast pace, so everyone has the chance to work on exciting projects
                            and try new things. You'll get to solve problems and deliver in a big way.</p>
                ...
                <div class="col-sm-6 col-md-4 no-padding">
                    <div class="our-philosophy-inner our-philosophy-inner-bg-2">
                        <h2>Our Vision</h2>
                        <p>Our purpose is to build solutions that remove the barriers preventing people from doing their best work, and this is at the heart of how we approach our own work, every day. We set our sights high and want to have a significant
                            impact on the people we reach, as we have plans for improvements and expansion.</p>
                ...
                <div class="col-sm-6 col-md-4 no-padding">
                    <div class="our-philosophy-inner our-philosophy-inner-bg-3">
                        ...
                        <p>Learning and Growth. We’re building a learning organization, so you not only develop your craft but your ability to partner with others and be a strong team member. We know that building a high trust, high performance company takes
                            grit. So, we stay connected and approach each challenge together.</p>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="main-title wow zoomIn">
                        <div class="main-shadow-heading">
                            <h2>Meet Briskit Agency Core Team</h2>
                        </div>
                        <h2>Meet Briskit Agency Core Team</h2>
            ...
            <div class="row">
                    ...
                    <article class="entry-team">
                        <div class="team-member">
                            <div class="team-member-featured">
                                <img src="<?= base_url() ?>assets/images/team/team-1.jpg" class="img-responsive" alt="Ahmed Abd-Alhaleem" />
                            </div>
                            <div class="team-member-main">
                                <div class="team-member-info">
                                    <div class="team-member-header">
                                        <h3 class="team-member-title"><a href="#" title="Ahmed Abd-Alhaleem">Ahmed
                                                Abd-Alhaleem</a></h3>
                ...
                <div class="col-sm-6 col-md-3">
                    <article class="entry-team">
                        <div class="team-member">
                            <div class="team-member-featured">
                                <img src="<?= base_url() ?>assets/images/team/team-2.png" class="img-responsive" alt="Ahmed Abd-Alhaleem" />
                            </div>
                            <div class="team-member-main">
                                <div class="team-member-info">
                                    <div class="team-member-header">
                ...
                <div class="col-sm-6 col-md-3">
                    <article class="entry-team">
                        <div class="team-member">
                            <div class="team-member-featured">
                                <img src="<?= base_url() ?>assets/images/team/team-3.png" class="img-responsive" alt="Ahmed Abd-Alhaleem" />
                            </div>
                            <div class="team-member-main">
                                <div class="team-member-info">
                                    <div class="team-member-header">
                                        <h3 class="team-member-title"><a href="#" title="Ahmed Abd-Alhaleem">Mohamed
                                                Habaza</a></h3>
                ...
                <div class="col-sm-6 col-md-3">
                    <article class="entry-team">
                        <div class="team-member">
                            <div class="team-member-featured">
                                <img src="<?= base_url() ?>assets/images/team/team-4.png" class="img-responsive" alt="Ahmed Abd-Alhaleem" />
                            </div>
                            <div class="team-member-main">
                                <div class="team-member-info">
                                    <div class="team-member-header">
                                        <h3 class="team-member-title"><a href="#" title="Ahmed Abd-Alhaleem">Amr Gamal
                                                Sadeq</a></h3>
                    ...
                    <div id="client-bg-2-slider" class="owl-carousel all-carousel owl-theme">
                        <div class="client-2-slider">
                            <div class="client-2-slider-content">
                                ...
                                <h3>In my job as social media strategist, I've tried every analytics product on the market and when I came across Briskit Agency, I was blown away! </h3>
                                <img src="<?= base_url() ?>assets/images/client/client-user-1.png" alt="">
                            </div>
                        ...
                        <div class="client-2-slider">
                            <div class="client-2-slider-content">
                                <span><i class="fa fa-quote-left"></i></span>
                                <h3>The ability to generate reports that tell more about a website than a prospect knows is the key to building business using Briskit Agency.</h3>
                                <img src="<?= base_url() ?>assets/images/client/client-user-2.png" alt="">
                            </div>
                            <h2>Fouad Badawy</h2>
                            <h3>CEO</h3>
                        </div>
                        <div class="client-2-slider">
                            <div class="client-2-slider-content">
                                <span><i class="fa fa-quote-left"></i></span>
                                <h3>Briskit Agency is one of the most impressive social media software efforts I've ever seen. From the intuitive interface to the powerful tools.</h3>
                                <img src="<?= base_url() ?>assets/images/client/client-user-3.png" alt="">
                            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="join-team subscribe-content clearfix wow zoomIn">
                        <div class="col-md-7">
                            <p><span><i class="icon icon-MessageLeft"></i></span> Briskit Agency enterprise SEO and content marketing platform provides competitive insight and market analysis no one can duplicate. </p>
                        </div>
                        <div class="col-md-5">
                ...
                <div class="col-md-12">
                    <div id="client-slider" class="owl-carousel all-carousel owl-theme">
                        <div class="client-slider">
                            <img src="<?= base_url() ?>assets/images/client/client-1.png" alt="">
                        </div>
                        <div class="client-slider">
                            <img src="<?= base_url() ?>assets/images/client/client-2.png" alt="">
                        </div>
                        <div class="client-slider">
                            <img src="<?= base_url() ?>assets/images/client/client-3.png" alt="">
                        </div>
                        <div class="client-slider">
                            <img src="<?= base_url() ?>assets/images/client/client-4.png" alt="">
                        </div>
                        <div class="client-slider">
                            <img src="<?= base_url() ?>assets/images/client/client-5.png" alt="">
                        </div>
                        <div class="client-slider">
                            <img src="<?= base_url() ?>assets/images/client/client-6.png" alt="">
                        </div>
                        <div class="client-slider">
                            <img src="<?= base_url() ?>assets/images/client/client-1.png" alt="">
                        </div>
